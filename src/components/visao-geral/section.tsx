  ...
  return (
    <section className="space-y-4">
      <div className="flex items-center gap-3 border-b border-border/30 pb-2">
        {Icon && (
          <div
            className={`flex h-6 w-6 items-center justify-center rounded-md bg-primary/10 ${colorClass}`}
          >
        ...
        <div className="flex min-w-0 flex-1 items-baseline gap-3">
          ...
          <p className="truncate text-xs text-muted-foreground/70 leading-relaxed">{insight}</p>
        </div>
      </div>
      {children}
    </section>
