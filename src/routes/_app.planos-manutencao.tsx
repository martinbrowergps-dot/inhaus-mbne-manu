...
const detailCols: ColumnDef<ChecklistEnriched>[] = [
  ...
  { accessorKey: "_tag", header: "TAG" },
  {
    ...
    cell: ({ getValue }) => {
      ...
      return (
        <Badge variant="outline" className={cn("text-[11px] font-bold", color)}>
          {v}
        </Badge>
      );
    },
...
function ChecklistsPage() {
  ...
  return (
    <div data-page="planos-manutencao" className="space-y-6">
      <PageHeader
          ...
          {(
            ...
            <TabsContent key={key} value={key} className="m-0 space-y-4">
              <div className="grid gap-3 sm:grid-cols-3">
                ...
                <SummaryCard
                  icon={
                    <Badge variant="outline" className="border-warning/30 text-warning text-[11px]">
                      h
                    </Badge>
                  }
